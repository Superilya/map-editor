...
import { editStart, editSubmit, editCancel } from 'src/ducks/room-editing/actions';
import { BuildingPageParams, BuildingPageQuery } from 'src/types/routing';
import { selectTargetRoom, selectIsSubmitting } from 'src/ducks/room-editing/selectors';
...
export const Tool = withRouter(connect(
    mapStateToProps,
    { changeMyPlace, editStart, editSubmit, editCancel }
)(ToolView));
