...
export const selectIsBuildingsLoading = (state: RootStoreType) =>
    state.buildings.state.isBuildingsLoading;
export const selectTargetBuilding = (buildingId: Building['id']) => (
    state: RootStoreType
